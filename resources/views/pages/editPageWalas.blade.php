      ...
      <div class="bg-white rounded-3xl p-8 mb-5">
        ...
        <hr class="my-10">
          ...
          <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 class="mt-10 text-center text-xl font-normal leading-9 tracking-tight text-gray-900">Edit data <strong>{{$walas->username}}</strong> </h2>
            <div>
              @if ($errors->any())
                <div>
              ...
              <form class="space-y-6" action="/walas" method="POST">
                ...
                <div>
                  ...
                  <input type="hidden" value="{{$walas->id}}" name="walas_id">
                  <div class="mt-2">
                    <input id="nuptk" disabled value="{{$walas->nuptk}}" name="nuptk" type="text" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none">
                  </div>
                </div>
                <div>
                  <label for="username" class="block text-sm font-medium leading-6 text-gray-900">Username</label>
                  <div class="mt-2">
                    <input id="username" value="{{$walas->username}}" name="username" type="text" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                  </div>
                </div>

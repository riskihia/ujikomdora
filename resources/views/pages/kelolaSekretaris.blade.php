    ...
    <div class="max-w-4xl mx-auto">
      <div class="bg-white rounded-3xl p-8 mb-5">
        ...
        <div class="p-4 bg-white border rounded-xl text-gray-800 space-y-2">
          <div class="flex gap-2">
            <button id="btn-list-Sekretaris" class="bg-green-500 hover:bg-blue-700 text-white py-1 px-2 font-semibold rounded">List</button>
            <button id="btn-create-Sekretaris" class="bg-green-500 hover:bg-blue-700 text-white py-1 px-2 font-semibold rounded">Create</button>
          </div>

          {{-- list sekretaris --}}
          <div id="listAccSekretaris" class="relative overflow-x-auto">
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">List akun sekretaris</h2>
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  ...
                  @foreach ($sekretaris as $sekretaris_item)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                            {{ $sekretaris_item->created_at }}
                        </td>
                        <td class="px-6 py-4">
                          <a href='{{url("/sekretaris/$sekretaris_item->id/edit")}}' class="bg-yellow-200 py-1 px-2 rounded-md cursor-pointer">Edit</a>

                          {{-- button delete --}}
                          <form action="/sekretaris" class="inline" method="POST">
                            @method('DELETE')
                            @csrf
                            <input type="hidden" name="sekretaris_id" value="{{$sekretaris_item->id}}">
          ...
          <div id="createAccSekretaris" class="hidden mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Create akun Sekretaris</h2>
            <div>
              @if ($errors->any())
                <div>

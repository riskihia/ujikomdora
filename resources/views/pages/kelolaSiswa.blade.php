      ...
      <div class="bg-white rounded-3xl p-8 mb-5">
        ...
        <div id="panel-rpl1" class="p-4 bg-white border rounded-xl text-gray-800 space-y-2">
          ...
          <div id="rpl1-listKelolaSiswa" class="relative overflow-x-auto">
            <h2 class="text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">List akun RPL 1 aa aja anjay</h2>
                ...
                <tbody>
                  ...
                  @foreach ($siswas as $item)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-6 py-4">
                          <a href='{{url("/walas/$item->id/edit")}}' class="bg-yellow-200 py-1 px-2 rounded-md cursor-pointer">Edit</a>

                          {{-- button delete --}}
                          <form action="walas" class="inline" method="POST">
                            @method('DELETE')
                            @csrf
                            <input type="hidden" name="walas_id" value="{{$item->id}}">
            ...
            <div>
              ...
              <form class="space-y-6" action="/walas" method="POST">
                ...
                <div>
                  ...
                  <div class="mt-2">
                    <input name="nuptk" type="text" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div class="mt-2">
                    <input name="password" type="password" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                  </div>
                </div>
        ...
        <div id="panel-rpl2" class="hidden p-4 bg-white border rounded-xl text-gray-800 space-y-2">
          ...
          <div id="rpl2-listKelolaSiswa" class="relative overflow-x-auto">
            <h2 class="text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">List akun RPL2</h2>
